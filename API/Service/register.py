...
def register_by_custodial_wallets(algod_client, indexer_client, opt_app_id):
    ...
    if wallet_info == "True":
        try:
            txn_object = transactions.Controller.register.register_by_custodial_wallets(algod_client, indexer_client, sender_wallet, opt_app_id,
