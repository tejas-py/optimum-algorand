...
def register_by_custodial_wallets(algod_client, indexer_client, sender_wallet, app_id, governance_address, memo):
    ...
    custodial_wallets = utils.common_functions.get_custodian_wallets(algod_client, indexer_client, app_id, {"registered": 0})
